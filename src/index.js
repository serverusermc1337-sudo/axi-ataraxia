...
function known(name) {
  return [
    ...
    "wuerfel", "muenze", "achtball", "witz", "play", "join", "skip", "stop", "warteschlange", "aktuell", "radio", "ticket", "schliessen", "warn", "verwarnungen", "timeout", "kick", "ban",
    ...
    "befehl", "entfernen", "wissen", "ki", "anpassen", "optimieren", "regeln", "akzeptieren", "freigabe", "widerruf", "selfrole", "sprachfilter",
  ].includes(name);
}
